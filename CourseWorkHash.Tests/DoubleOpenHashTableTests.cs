...
{
    [TestClass]
    public class DoubleOpenHashTableTests
    {
        [TestMethod]
        public void Add_ExistentValue_FalseReturned()
        {
            // arrange
            DoubleOpenHashTable hashTable = new DoubleOpenHashTable(2, new DivisionHashFunc(), new DivisionHashFunc());
        ...
        {
            // arrange
            DoubleOpenHashTable hashTable = new DoubleOpenHashTable(4, new DivisionHashFunc(), new MidSquareHashFunc());
